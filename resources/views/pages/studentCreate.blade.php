        ...
        <div class="bg-blue-100 w-full h-full">
            ...
            <div class="bg-blue-100 w-full h-full flex items-center justify-center">
                <div class="form-container w-[92%] h-auto bg-white rounded-md mt-[-300px]">
                    <form action="{{ route('pages.student.store')}}" method="POST">
                        @csrf
                          ...
                          <div class="border-b border-gray-900/10 pb-12">
                            <div class="mt-10 ml-6 mr-6 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                <div class="col-span-full">
                                    ...
                                    <div class="mt-2">
                                      <input  type="number" id="nis" name="nis" rows="3" class="block w-full rounded-md pl-3 border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder="Masukkan NIS"></input>
                                    </div>
                                  </div>
