...
<body>
    <div class="container">
        ...
        <div class="data">
            ...
            <table>
                <tr><td>NIS</td><td>:</td> <td>{{ $students[0]['nis'] }} </td></tr>
                <tr><td>Nama</td><td>:</td> <td>{{ $students[0]['name'] }} </td></tr>
                <tr><td>Rombel</td><td>:</td> <td> {{ $students[0]['rombel']['rombel']}}</td> </tr>
                <tr><td>Rayon</td><td>:</td> <td> {{ $students[0]['rayon']['rayon'] }}</td></tr>
            </table>
        </div>
        <div class="description">
            <p>Dengan ini menyatakan saya telah melakukan pelanggaran tata tertib sekolah,
                yaitu terlambat datang ke sekolah sebanyak <b>{{ $late->count() }} kali</b> yang mana hal tersebut termasuk
