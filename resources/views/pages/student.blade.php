...
<template>
    ...
    <div class="bg-blue-100 w-full h-full">
        <div class="flex flex-col justify-start ml-20 mb-[-150px]">
            <h1 class="text-3xl mt-8">Tambah Data Siswa {{ Auth::user()->name }}</h1>
        ...
        <div class="flex items-center justify-center">
            <div class="data-container w-[92%] h-auto bg-white rounded-md mt-[180px]">
                <div class="button mt-6">
                    <a href="{{ route('pages.student.create')}}" class="w-[200px] h-[80px] rounded-md text-white px-3 py-2 text-x ml-12" style="background: rgb(0, 145, 255);">Tambah Data Siswa</a>
                </div>
                    ...
                    <tbody class="">
                        ...
                        <td>
                            <div class="button-container">
                                <div class="edit-btn">
                                    <a href="{{ route('pages.student.edit', $data->id)}}" class="edit-button">Edit</a>
                                </div>
                                <form action="{{ route('pages.student.destroy', $data->id) }}" method="POST" style="display: inline;">
                                    @csrf
                                    @method('DELETE')
